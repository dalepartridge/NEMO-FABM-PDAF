...
# if defined key_roam
               zdic(jpi,jpj),zalk(jpi,jpj),zoxy(jpi,jpj),             &
               ztmp(jpi,jpj),zsal(jpi,jpj),                           &
# endif
# if defined key_mocsy
               zpho(jpi,jpj),                                         &
# endif
               fthetan(jpi,jpj),fprn(jpi,jpj),frn(jpi,jpj),           &
               ...
               xFree(jpi,jpj),                                        &
               fgmipn(jpi,jpj),fgmid(jpi,jpj),fgmidc(jpi,jpj),        &
...
# endif
               ...
               fsedn(jpi,jpj),fsedsi(jpi,jpj),fsedfe(jpi,jpj),        &
...
# if defined key_roam
               ftot_c(jpi,jpj),ftot_a(jpi,jpj),ftot_o2(jpi,jpj),      &
               fflx_c(jpi,jpj),fflx_a(jpi,jpj),fflx_o2(jpi,jpj),      &
! I don't think fifd_a, fifd_o2, fofd_a or fofd_o2 are used - marc 11/5/17
!               fifd_c(jpi,jpj),fifd_a(jpi,jpj),fifd_o2(jpi,jpj),      &
!               fofd_c(jpi,jpj),fofd_a(jpi,jpj),fofd_o2(jpi,jpj),      &
               fifd_c(jpi,jpj), fofd_c(jpi,jpj),                      &
# endif
               fzmi_i(jpi,jpj),fzmi_o(jpi,jpj),fzme_i(jpi,jpj),       &
               fzme_o(jpi,jpj),                                       &
...
# if defined key_roam
               ...
               f_henry(jpi,jpj),                                      &
               f_pp0(jpi,jpj),                                        &
               f_kw660(jpi,jpj),f_o2flux(jpi,jpj),f_o2sat(jpi,jpj),   &
...
# endif
               f_sbenin_n(jpi,jpj),f_sbenin_fe(jpi,jpj),              &
               f_sbenin_c(jpi,jpj),                                   &
               ...
               f_benout_si(jpi,jpj),                                  &
               f_benout_c(jpi,jpj),f_benout_ca(jpi,jpj),              &
