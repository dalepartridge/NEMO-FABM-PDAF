...
!!gm
      ...
      DO jn = 1, kjpt                                       ! tracer loop
         ...
         DO jk = 1, jpkm1                                     ! interior values
            ...
            DO jj = 2, jpjm1
               DO ji = 2, jpim1   ! vector opt.
                  ...
                  zalpha = 0.5 - z0u
                  zu  = z0u - 0.5 * pun(ji,jj,jk) * zdt / ( e1u(ji,jj) * e2u(ji,jj) * e3u_n(ji,jj,jk) )
                  ...
                  zalpha = 0.5 - z0v
                  zv  = z0v - 0.5 * pvn(ji,jj,jk) * zdt / ( e1v(ji,jj) * e2v(ji,jj) * e3v_n(ji,jj,jk) )
         ...
         DO jk = 1, jpkm1                                     ! interior values
            ...
            DO jj = 2, jpjm1      
               DO ji = 2, jpim1   ! vector opt.
                  zbtr = 1. / ( e1t(ji,jj) * e2t(ji,jj) * e3w_n(ji,jj,jk+1) )
         ...
         DO jk = 1, jpkm1                    ! Compute & add the vertical advective trend
            DO jj = 2, jpjm1      
               DO ji = 2, jpim1   ! vector opt.
                  zbtr = 1. / ( e1e2t(ji,jj) * e3t_n(ji,jj,jk) )
