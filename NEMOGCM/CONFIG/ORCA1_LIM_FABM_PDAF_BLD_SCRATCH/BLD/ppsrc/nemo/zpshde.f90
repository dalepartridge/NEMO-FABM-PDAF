      ...
      IF( PRESENT( prd ) ) THEN         ! depth of the partial step level
         ...
         DO jj = 1, jpjm1
            DO ji = 1, jpim1
               ...
               ze3wv  = (gdept_0(ji,jj+1,ikv) - gdepw_0(ji,jj+1,ikv)) - (gdept_0(ji,jj,ikv) - gdepw_0(ji,jj,ikv))
               IF( ze3wu >= 0._wp ) THEN 
                  pgzu(ji,jj) = (gdep3w_n(ji+1,jj,iku) - ze3wu) - gdep3w_n(ji,jj,iku)
               ...
               ELSE  
                  pgzu(ji,jj) = gdep3w_n(ji+1,jj,iku) - (gdep3w_n(ji,jj,iku) + ze3wu)
               ...
               ENDIF
               IF( ze3wv >= 0._wp ) THEN
                  pgzv(ji,jj) = (gdep3w_n(ji,jj+1,ikv) - ze3wv) - gdep3w_n(ji,jj,ikv) 
               ...
               ELSE 
                  pgzv(ji,jj) = gdep3w_n(ji,jj+1,ikv) - (gdep3w_n(ji,jj,ikv) + ze3wv)
      ...
      IF( PRESENT( prd ) ) THEN         ! depth of the partial step level
         ...
         DO jj = 1, jpjm1
            DO ji = 1, jpim1
               ...
               ze3wv  = (gdepw_0(ji,jj+1,ikv+1) - gdept_0(ji,jj+1,ikv)) - (gdepw_0(ji,jj,ikv+1) - gdept_0(ji,jj,ikv))
               IF( ze3wu >= 0._wp ) THEN
                 pgzui  (ji,jj) = (gdep3w_n(ji+1,jj,iku) + ze3wu) - gdep3w_n(ji,jj,iku)
               ...
               ELSE
                 pgzui  (ji,jj) = gdep3w_n(ji+1,jj,iku) - (gdep3w_n(ji,jj,iku) - ze3wu)
               ...
               ENDIF
               IF( ze3wv >= 0._wp ) THEN
                 pgzvi  (ji,jj) = (gdep3w_n(ji,jj+1,ikv) + ze3wv) - gdep3w_n(ji,jj,ikv) 
               ...
               ELSE
                 pgzvi  (ji,jj) = gdep3w_n(ji,jj+1,ikv) - (gdep3w_n(ji,jj,ikv) - ze3wv)
