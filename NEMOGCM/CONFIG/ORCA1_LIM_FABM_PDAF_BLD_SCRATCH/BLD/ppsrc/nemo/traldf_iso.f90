...
!!!!!!!!!!CDIR PARALLEL DO PRIVATE( zdk1t ) 
         ...
         DO jk = 1, jpkm1
            DO jj = 1 , jpjm1
               DO ji = 1, jpim1   ! vector opt.
                  zabe1 = ( rldf * ahtu(ji,jj) * r_fact_lap(ji,jj,jk) + pahtb0 ) * re2u_e1u(ji,jj) * e3u_n(ji,jj,jk)
                  zabe2 = ( rldf * ahtv(ji,jj) + pahtb0 ) * re1v_e2v(ji,jj) * e3v_n(ji,jj,jk)
                  !
                  ...
                  !
                  zcof1 = - rldf * ahtu(ji,jj) * r_fact_lap(ji,jj,jk) * e2u(ji,jj) * uslp(ji,jj,jk) * zmsku
            ...
            DO jj = 2 , jpjm1
               DO ji = 2, jpim1   ! vector opt.
                  zbtr = 1.0 / ( e12t(ji,jj) * e3t_n(ji,jj,jk) )
