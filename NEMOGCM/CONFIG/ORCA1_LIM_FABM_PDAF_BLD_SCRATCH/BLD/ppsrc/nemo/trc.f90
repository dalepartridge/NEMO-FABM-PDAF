...
MODULE trc
  ...
  ! CHARACTER(len=2), DIMENSION(jptra), PUBLIC :: cn_trc_o ! choice of ocean tracer cc !GL - had to comment this
  ! +++>>> FABM 
   REAL(wp), DIMENSION(jpmaxtrc), PUBLIC         :: trc_ice_ratio, & ! ice-ocean tracer ratio !GL - note did not changed name!
                                                 trc_ice_prescr   ! prescribed ice trc cc !GL - note did not changed name!
