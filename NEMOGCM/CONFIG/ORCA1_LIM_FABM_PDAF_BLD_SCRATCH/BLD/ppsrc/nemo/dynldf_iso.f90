...
!!end
      ...
      DO jk = 1, jpkm1                                 ! Horizontal slab
         ...
         IF( ln_zps ) THEN      ! z-coordinate - partial steps : min(e3u)
            DO jj = 2, jpjm1
               DO ji = 2, jpi   ! vector opt.
                  zabe1 = (ahm1(ji,jj,jk)+ahmb0) * e2t(ji,jj) * MIN( e3u_n(ji,jj,jk), e3u_n(ji-1,jj,jk) ) / e1t(ji,jj)
         ...
         ELSE                   ! other coordinate system (zco or sco) : e3t
            DO jj = 2, jpjm1
               DO ji = 2, jpi   ! vector opt.
                  zabe1 = (ahm1(ji,jj,jk)+ahmb0) * e2t(ji,jj) * e3t_n(ji,jj,jk) / e1t(ji,jj)
         ...
         DO jj = 1, jpjm1
            DO ji = 1, jpim1   ! vector opt.
               zabe2 = ( ahm2(ji,jj,jk) + ahmb0 ) * e1f(ji,jj) * e3f_n(ji,jj,jk) / e2f(ji,jj)
         ...
         DO jj = 2, jpjm1
            DO ji = 1, jpim1   ! vector opt.
               zabe1 = ( ahm2(ji,jj,jk) + ahmb0 ) * e2f(ji,jj) * e3f_n(ji,jj,jk) / e1f(ji,jj)
         ...
         IF( ln_zps ) THEN      ! z-coordinate - partial steps : min(e3u)
            DO jj = 2, jpj
               DO ji = 1, jpim1   ! vector opt.
                  zabe2 = (ahm1(ji,jj,jk)+ahmb0) * e1t(ji,jj) * MIN( e3v_n(ji,jj,jk), e3v_n(ji,jj-1,jk) ) / e2t(ji,jj)
         ...
         ELSE                   ! other coordinate system (zco or sco) : e3t
            DO jj = 2, jpj
               DO ji = 1, jpim1   ! vector opt.
                  zabe2 = (ahm1(ji,jj,jk)+ahmb0) * e1t(ji,jj) * e3t_n(ji,jj,jk) / e2t(ji,jj)
