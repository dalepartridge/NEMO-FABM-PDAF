...
!
            ...
            DO jk = 1, jpkm1
               DO jj = 2, jpjm1
                  DO ji = 2, jpim1   ! vector opt.
                     ze3ta =  ( 1. - r_vvl ) +        r_vvl   * e3t_a(ji,jj,jk)   ! after scale factor at T-point
                     ze3tn =         r_vvl   + ( 1. - r_vvl ) * e3t_n(ji,jj,jk)   ! now   scale factor at T-point
                     zwi(ji,jj,jk) = - p2dt(jk) * zwt(ji,jj,jk  ) / ( ze3tn * e3w_n(ji,jj,jk  ) )
                     zws(ji,jj,jk) = - p2dt(jk) * zwt(ji,jj,jk+1) / ( ze3tn * e3w_n(ji,jj,jk+1) )
         ...
         DO jj = 2, jpjm1
            DO ji = 2, jpim1
               ze3tb = ( 1. - r_vvl ) + r_vvl * e3t_b(ji,jj,1)
               ze3tn = ( 1. - r_vvl ) + r_vvl * e3t_n(ji,jj,1)
         ...
         DO jk = 2, jpkm1
            DO jj = 2, jpjm1
               DO ji = 2, jpim1
                  ze3tb = ( 1. - r_vvl ) + r_vvl * e3t_b(ji,jj,jk)
                  ze3tn = ( 1. - r_vvl ) + r_vvl * e3t_n(ji,jj,jk)
