...
!!end
   ...
   SUBROUTINE ldfguv( pu, pv, plu, plv, kahm )
      ...
      DO jk = 1, jpkm1                ! First step !   ! Horizontal slab
         ...
         DO jj = 1, jpjm1
            DO ji = 2, jpi
               zabe1 = e2t(ji,jj) * e3t_n(ji,jj,jk) / e1t(ji,jj)
         ...
         DO jj = 1, jpjm1
            DO ji = 1, jpim1
               zabe2 = e1f(ji,jj) * e3f_n(ji,jj,jk) / e2f(ji,jj)
         ...
         DO jj = 1, jpjm1
            DO ji = 1, jpim1
               zabe1 = e2f(ji,jj) * e3f_n(ji,jj,jk) / e1f(ji,jj)
         ...
         DO jj = 2, jpj
            DO ji = 1, jpim1
               zabe2 = e1t(ji,jj) * e3t_n(ji,jj,jk) / e2t(ji,jj)
      ...
      DO jj = 2, jpjm1              !  Second step !   ! Horizontal slab
         ...
         DO jk = 2, jpkm1
            DO ji = 2, jpim1
               ...
               zcoef0 = e1u(ji,jj) * e2u(ji,jj) / e3u_n(ji,jj,jk)   &
         ...
         DO jk = 2, jpkm1
            DO ji = 2, jpim1
               ...
               zcoef0 = e1v(ji,jj) * e2v(ji,jj) / e3v_n(ji,jj,jk)   &
         ...
         IF( (kahm -nkahm_smag) ==1 ) THEN
            ...
            DO jk = 1, jpkm1
               DO ji = 2, jpim1
                  ...
                  zbur = ahm3(ji,jj,jk) / ( e1u(ji,jj)*e2u(ji,jj)*e3u_n(ji,jj,jk) )
                  zbvr = ahm4(ji,jj,jk) / ( e1v(ji,jj)*e2v(ji,jj)*e3v_n(ji,jj,jk) )
                  ! vertical divergence
         ...
         ELSEIF( (kahm +nkahm_smag ) == 2 ) THEN
            ...
            DO jk = 1, jpkm1
               DO ji = 2, jpim1
                  ...
                  zbur = 1. / ( e1u(ji,jj)*e2u(ji,jj)*e3u_n(ji,jj,jk) )
                  zbvr = 1. / ( e1v(ji,jj)*e2v(ji,jj)*e3v_n(ji,jj,jk) )
                  ! vertical divergence
                  zuav = zfuw(ji,jk) - zfuw(ji,jk+1)
                  zvav = zfvw(ji,jk) - zfvw(ji,jk+1)
