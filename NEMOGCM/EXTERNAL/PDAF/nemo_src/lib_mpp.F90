MODULE lib_mpp
   ...
   USE mod_parallel_pdaf, ONLY: init_parallel_pdaf, screen_parallel
#endif
...
#if defined key_USE_PDAF
      ! Split the MPI communicator into MODEL, FILTER and
      ! COUPLE communicators.
      screen_parallel = 3    ! PDAF output
      CALL init_parallel_pdaf(screen_parallel, mpi_comm_opa)
#endif
